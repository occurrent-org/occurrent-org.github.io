...
Most of these capabilities are mixins you reach with a static probe rather than a cast, because the model you're holding is usually several wrappers deep:
