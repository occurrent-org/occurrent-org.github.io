...
These and the saga timer name are the only source-breaking changes in this release. `org.occurrent.UpgradeToOccurrent_0_33` renames all five interfaces, `SubscriptionModelWrapper`'s two methods, the TCK base class, and both `of` methods for you, in Java and Kotlin alike. See the [upgrade guide](https://github.com/johanhaleby/occurrent/blob/main/doc/migration/upgrading-to-0.33.0.md).
