...
Upgrading from an earlier version? Most of the mechanical changes are automated by an OpenRewrite recipe, so see the [upgrade guide](https://github.com/johanhaleby/occurrent/blob/main/doc/migration/upgrading-to-0.30.0.md) for the recipe setup and the steps that still need a manual pass.
