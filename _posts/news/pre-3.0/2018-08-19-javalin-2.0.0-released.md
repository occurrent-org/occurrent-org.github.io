...
permalink: /news/occurrent-2.0.0-stable.html
layout: news
category: news
date: 2018-08-19
version: 2.0.0
title: Occurrent 2.0 stable is ready!
summary: We're very happy to announce that Occurrent 2.0 is released. It has a lot of new features and quality of life improvements. It also has some breaking changes.
---

## Introducing Occurrent 2.0
...
### What's changed since Occurrent 1.7 ?
...
* Occurrent now has a pac4j implementation ([https://github.com/pac4j/occurrent-pac4j](https://github.com/pac4j/occurrent-pac4j))
...
We've created a [migration guide](/migration-guide-occurrent-1-to-2) for users upgrading from 1.X.
